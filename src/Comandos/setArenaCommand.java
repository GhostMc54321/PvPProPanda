...
public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
  {
    ...
    if ((p.hasPermission("pluspvp.cmd.setarenas")) && 
      ...
      if (args.length == 0)
      {
        p.sendMessage("§5§lEPIC§F§lKITS§c ➜ §cOps! Use isso De Maneira Correta: §f/setarena <1 até 10>");
        return true;
      }
      if (args[0].equalsIgnoreCase("1"))
      {
        p.sendMessage("§5§lEPIC§F§lKITS§c ➜ §aVocê setou a arena §e(SPAWN POINT) §f1");
      ...
      {
        p.sendMessage("§5§lEPIC§F§lKITS§c ➜ §aVocê setou a arena §e(SPAWN POINT) §f2");
      ...
      {
        p.sendMessage("§5§lEPIC§F§lKITS§c ➜ §aVocê setou a arena §e(SPAWN POINT) §f3");
      ...
      {
        p.sendMessage("§5§lEPIC§F§lKITS§c ➜ §aVocê setou a arena §e(SPAWN POINT) §f4");
      ...
      {
        p.sendMessage("§5§lEPIC§F§lKITS§c ➜ §aVocê setou a arena §e(SPAWN POINT) §f5");
      ...
      {
        p.sendMessage("§5§lEPIC§F§lKITS§c ➜ §aVocê setou a arena §e(SPAWN POINT) §f6");
      ...
      {
        p.sendMessage("§5§lEPIC§F§lKITS§c ➜ §aVocê setou a arena §e(SPAWN POINT) §f7");
      ...
      {
        p.sendMessage("§5§lEPIC§F§lKITS§c ➜ §aVocê setou a arena §e(SPAWN POINT) §f8");
      ...
      {
        p.sendMessage("§5§lEPIC§F§lKITS§c ➜ §aVocê setou a arena §e(SPAWN POINT) §f9");
      ...
      {
        p.sendMessage("§5§lEPIC§F§lKITS§c ➜ §aVocê setou a arena §e(SPAWN POINT) §f10");
